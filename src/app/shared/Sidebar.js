  ...
  render () {
    return (
      <nav className="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul className="nav">
            ...
            <Collapse in={ this.state.basicUiMenuOpen }>
              <div>
                <ul className="nav flex-column sub-menu">
                  <li className="nav-item"> <Link className={ this.isPathActive('/basic-ui/buttons') ? 'nav-link active' : 'nav-link' } to="/basic-ui/buttons"><Trans>Create/Manage Presale</Trans></Link></li>
                  <li className="nav-item"> <Link className={ this.isPathActive('/basic-ui/dropdowns') ? 'nav-link active' : 'nav-link' } to="/basic-ui/dropdowns"><Trans>Launchpad Listings</Trans></Link></li>
                </ul>
              </div>
            </Collapse>
          </li>
          ...
          <li className={ this.isPathActive('/form-elements/basic-elements') ? 'nav-item menu-items active' : 'nav-item menu-items' }>
            <Link className="nav-link" to="/form-elements/basic-elements">
              ...
              <span className="menu-title"><Trans>Sphynx Swap</Trans></span>
            </Link>
          </li>
        ...
        <img className="tree-image" src={require('../../assets/images/new_images/images/tree.png')} alt="tree-image" />
      </nav>
    );
  }
